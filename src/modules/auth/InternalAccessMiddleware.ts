...
export class InternalAccessMiddleware implements NestMiddleware {
    ...
    constructor() {
        ...
        this.limiters['/auth'] = new RateLimiterMemory({ points: 5, duration: 60, execEvenly: true, keyPrefix: 'auth' });
        this.limiters['/api'] = new RateLimiterMemory({ points: 100, duration: 60, execEvenly: true, keyPrefix: 'api' });
    }
